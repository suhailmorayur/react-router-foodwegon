...
<article className='flex flex-col items-center justify-center gap-1'>
  <img className='h-28' src=" ./public/Map Marker.png" alt="" />
...
<article className='flex flex-col items-center justify-center'>
  <img className='h-28' src=" ./public/choose order.png" alt="" />
...
<article className='flex flex-col items-center justify-center'>
  <img className='h-28' src=" ./public/pay advanced.png" alt="" />
...
<article className='flex flex-col items-center justify-center'>
  <img className='h-28' src=" ./public/enjoy meals.png" alt="" />
